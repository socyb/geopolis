...
(() => {
  ...
  const sessions = [
    ...
    [ 9,"2026-09-15","EN LÍNEA","Radar de noticias geopolíticas","Trabajo guiado asincrónico · 2 h","III"],
    [10,"2026-09-17","F-101","Estados Unidos y China","Competencia · desacoplamiento","III"],
    [11,"2026-09-22","A-004","La guerra de los chips","Tecnología · cuellos de botella","III"],
    [12,"2026-09-24","F-101","Fragmentación geoeconómica","Bloques · comercio · inversión","III"],
    [13,"2026-09-29","A-004","Mapa regional y primer parcial","Integración · síntesis","IV"],
    [14,"2026-10-01","F-101","Nord Stream y seguridad energética","Infraestructura · dependencia","IV"],
    [15,"2026-10-06","A-004","Minerales críticos","Transición energética · negociación","IV"],
    [16,"2026-10-08","F-101","Cuellos de botella marítimos","Panamá · Suez · Mar Rojo","IV"],
    [17,"2026-10-13","A-004","Apple, China y poder estructural","Cadenas globales de valor","IV"],
    [18,"2026-10-15","F-101","IA y cadenas de suministro","Datos · trabajo · infraestructura","V"],
    [19,"2026-10-20","A-004","Pregunta de investigación","Equipos · problema · evidencia","V"],
    [20,"2026-10-22","F-101","El policy memo","Argumento · audiencia · decisión","V"],
    [21,"2026-10-27","A-004","Nearshoring en México","Localización · productividad","V"],
    [22,"2026-10-29","F-101","Estrategias de empresas multinacionales","Adaptación · influencia · salida","V"],
    [23,"2026-11-03","A-004","Matriz de riesgo geopolítico","Probabilidad · impacto · respuesta","V"],
    [24,"2026-11-05","F-101","Sala de consejo","Simulación · decisión bajo presión","V"],
    [25,"2026-11-10","A-004","La Franja y la Ruta","Infraestructura · financiamiento","V"],
    [26,"2026-11-12","F-101","China y América Latina","Comercio · dependencia · agencia","V"],
    [27,"2026-11-17","A-004","Clínica de evidencia y segundo parcial","Contraste · revisión entre pares","VI"],
    [28,"2026-11-19","F-101","México en América del Norte","T-MEC · autonomía · vulnerabilidad","VI"],
    [29,"2026-11-24","A-004","México entre Estados Unidos y China","Automotriz · chips · inversión","VI"],
    [30,"2026-11-26","F-101","Corredores y posición de México","Istmo · frontera · logística","VI"],
    [31,"2026-12-01","A-004","Integración final","Presentaciones · examen final","VI"],
    [32,"2026-12-03","F-101","Cierre del semestre","Retroalimentación · recuperación","VI"]
